...
public class ArrayDeque<E> implements Deque<E> {
    ...
    private void moveRight(int realIndex) {
    ...
    private void ensureIndex(int realIndex) {
        if ( this.head > realIndex || realIndex > this.tail) {
            throw new IndexOutOfBoundsException("Index out of bounce for index: " + (realIndex - this.head));
        }
    }
